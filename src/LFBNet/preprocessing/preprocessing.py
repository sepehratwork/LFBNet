...
def read_pet_gt_resize_crop_save_as_3d_andor_mip(
        data_path: str = None, data_name: str = None, saving_dir: str = None, save_3D: bool = True, crop: bool = True,
...
if __name__ == '__main__':
    ...
    saving_dir_mip = read_pet_gt_resize_crop_save_as_3d_andor_mip(
        ...
        output_resolution=[64, 64, 128], desired_spacing=None, generate_mip=True
        )
